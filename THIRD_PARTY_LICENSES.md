...
2. schedule
    - License: MIT License
    - https://github.com/dbader/schedule/blob/master/LICENSE.txt
...
4. pymodbus
    ...
    - https://github.com/pymodbus-dev/pymodbus/blob/dev/LICENSE
...
8. highspy
    - License: MIT License
    - https://github.com/ERGO-Code/HiGHS/blob/master/LICENSE.txt
